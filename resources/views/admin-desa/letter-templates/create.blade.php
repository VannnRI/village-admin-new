...
<div class="container mx-auto max-w-2xl bg-white rounded-lg shadow-md p-8">
    <form action="{{ route('admin-desa.letter-templates.store') }}" method="POST">
        ...
        <div class="mb-2 mt-2 p-3 bg-gray-50 border rounded text-sm">
            <b>Keterangan Tipe Field:</b>
            <ul class="list-disc ml-6 mt-1">
                <li><b>Text:</b> Input bebas (huruf/angka).</li>
                <li><b>Number:</b> Hanya boleh angka.</li>
                <li><b>Date:</b> Pilih tanggal dari kalender.</li>
                <li><b>Textarea:</b> Input teks panjang.</li>
                <li><b>Select/Radio/Checkbox:</b> Masukkan opsi pilihan, pisahkan dengan koma di kolom 'Opsi'.</li>
            </ul>
        </div>
