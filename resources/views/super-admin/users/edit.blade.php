...
@section('sidebar')
    ...
    <div class="flex flex-col items-center justify-center py-6 px-2 bg-gradient-to-br from-blue-200 to-green-50 rounded-xl mb-4 shadow">
        ...
        <div class="text-center">
            <div class="text-base font-bold text-blue-700">{{ $currentUser->name ?? 'Super Admin' }}</div>
                ...
                <div>
                    ...
                    <select name="village_id" id="village_id" required
                        ...
                        @foreach($villages as $village)
                            <option value="{{ $village->id }}" {{ old('village_id', $user->villages->first() ? $user->villages->first()->id : '') == $village->id ? 'selected' : '' }}>
                                {{ $village->name }}
                            </option>
                        @endforeach
                    </select>
